(function () {
  const dictionaries = {
    zh: {
      ...
      heroBody: "从暮色到晨露，把想喝的、想念的依次写进酒单；灯光落杯时，就从这一杯开始。", browseRecipes: "浏览配方", randomPick: "随机一杯",
      ...
      partyRandom: "聚会随机推荐", avoidRepeat: "优先可制作且避免重复", createRecipe: "记录我的配方", customAutoSave: "自定义并自动保存", recentViewed: "最近查看", pwaInstallTitle: "把朝露酒笺装到手机桌面", pwaInstallBody: "像 App 一样全屏打开；首次联网载入后，离线也能查看配方与管理本地数据。", pwaInstallButton: "安装 / 查看步骤", pwaGuideTitle: "添加到 iPhone 主屏幕", pwaStep1Title: "使用 Safari 打开在线版", pwaStep1Body: "请不要停留在微信、QQ 或其他应用的内置浏览器。", pwaStep2Title: "点击 Safari 的“分享”按钮", pwaStep2Body: "图标通常是一个向上箭头伸出方框。", pwaStep3Title: "选择“添加到主屏幕”", pwaStep3Body: "若没有看到，请向下滚动分享菜单。", pwaStep4Title: "确认名称并点击“添加”", pwaStep4Body: "以后可从桌面图标全屏打开，数据仍保存在这台设备上。", pwaGuideDone: "我知道了",
      recipeLibrary: "配方库", recipeSubtitle: "私人酒笺、经典配方与灵感特调。", searchPlaceholder: "搜索中文名、英文名或材料", clearFilters: "清除筛选",
      ...
      all: "全部", allOrigins: "全部分类", allBases: "全部基酒", allTastes: "全部口味", allDifficulties: "全部难度", originPersonal: "私人酒笺", originClassic: "经典配方", originConvenience: "灵感特调", originCustom: "我的创作",
    ...
    en: {
      ...
      heroBody: "From dusk to morning dew, gather the drinks and memories meant for tonight, then begin with one glass.", browseRecipes: "Browse recipes", randomPick: "Pick one",
      ...
      partyRandom: "Party randomizer", avoidRepeat: "Prefer makeable drinks and avoid repeats", createRecipe: "Record my recipe", customAutoSave: "Create and save locally", recentViewed: "Recently viewed", pwaInstallTitle: "Put Dawn's Dew on your home screen", pwaInstallBody: "Open it like an app; after the first online visit, recipes and local data remain available offline.", pwaInstallButton: "Install / See steps", pwaGuideTitle: "Add to your iPhone Home Screen", pwaStep1Title: "Open the online version in Safari", pwaStep1Body: "Do not stay inside WeChat, QQ or another in-app browser.", pwaStep2Title: "Tap Safari’s Share button", pwaStep2Body: "It usually looks like an upward arrow coming out of a box.", pwaStep3Title: "Choose Add to Home Screen", pwaStep3Body: "Scroll down in the Share sheet if it is not visible.", pwaStep4Title: "Confirm the name and tap Add", pwaStep4Body: "Use the home-screen icon for a full-screen launch; data stays on this device.", pwaGuideDone: "Got it",
      recipeLibrary: "Recipe library", recipeSubtitle: "Personal notes, classics and inspired mixes.", searchPlaceholder: "Search names or ingredients", clearFilters: "Clear filters",
