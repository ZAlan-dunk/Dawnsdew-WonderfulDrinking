...
const version = "0.2";
const artifactRoot = process.env.DAWNSDEW_ARTIFACT_ROOT ? path.resolve(process.env.DAWNSDEW_ARTIFACT_ROOT) : path.join(root, "packages");
const packageDir = path.join(artifactRoot, "DawnsDew-v0.2-Beta-Standalone");
const outputName = "DawnsDew-v0.2-Beta-Standalone.html";
...
html = html.replace("<head>", '<head>\n  <meta name="dawnsdew-package" content="v0.2-beta-standalone">');
...
const guide = `朝露酒笺 · Dawn's Dew v0.2 Beta 单文件封装版\n\n` +
  `直接分享文件：${outputName}\n\n` +
